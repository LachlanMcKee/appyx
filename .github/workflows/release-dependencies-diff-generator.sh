...
baselineDependenciesDir=$INPUT_BUILD_ROOT_DIR/build/release-dependencies-diff/baseline-dependencies
dependenciesDir=$INPUT_BUILD_ROOT_DIR/build/release-dependencies-diff/dependencies
